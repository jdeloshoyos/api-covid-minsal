...
# Clase datosMuestraID: Obtiene los datos de una muestra por su ID

import json
import requests

class c_datosMuestraID:
    ...
    def llamar(self, muestra_id):
        """
        Llama a la API con un ID de muestra a consultar.
        ...
        if isinstance(muestra_id, int):
            parametros = json.dumps({"id_muestra": muestra_id})
